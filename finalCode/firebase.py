...
# ACCESS_TOKEN = 'RyENpPtJU2gVF7PLHSQn'
...
# def read_and_send_data():
#     vibration, vibration_value = read_sensor_data(vibration_file)
#     pressure, pressure_value = read_sensor_data(pressure_file)
#     gps_data, gps_signal = read_gps_data()

#      # ThingsBoard에 데이터 전송
#     send_data_to_thingsboard(vibration_value, pressure_value, gps_data, gps_signal)
...
# def send_data_to_thingsboard(vibration_value, pressure_value, gps_data):
#     telemetry_data = {
#         "vibration": float(vibration_value[0]) if vibration_value else 0,
#         "pressure": [float(p) for p in pressure_value] if pressure_value else [0, 0, 0, 0],
#         "gps_latitude": gps_data[0],
#         "gps_longitude": gps_data[1]
#     }
#     client.publish('v1/devices/me/telemetry', json.dumps(telemetry_data))
#     print("Sensor data sent to ThingsBoard.")
